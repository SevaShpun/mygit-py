...
""".format(
str(user.json_load()["lvl"]["gold"]),
str(user.json_load()["lvl"]["wood"]),
str(user.json_load()["lvl"]["stone"]),
str(user.json_load()["lvl"]["food"]),
str(user.json_load()["res"]["gold"]),
str(user.json_load()["res"]["wood"]),
str(user.json_load()["res"]["stone"]),
str(user.json_load()["res"]["food"]),
str(self.result_down))
